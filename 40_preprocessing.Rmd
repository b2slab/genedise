...
omnipath_g <- graph_from_edgelist(omnipath_df, directed = FALSE) %>% simplify %>% largest_cc
summary(omnipath_g)
```
...
save(
  df_ensembl_uniprot, df_info, file = paste0(config$dir_data, 
  "/table_map_ensembl2uniprot.RData"), compress = "xz")
