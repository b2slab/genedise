...
```{r}
load(paste0(config$dir_performance, "/data_cv_splits.RData"))
```
...
cv_scheme <- "representative"
split_cv_name <- "Rep01.Fold2"
input_type <- "drugs"
df_in <- filter(df_input, disease==disease_name&input_type=="drugs")
```
